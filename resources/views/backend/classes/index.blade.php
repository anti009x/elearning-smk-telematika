    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('classes.create') }}"
                    ...
                    <span class="ml-2 text-xs font-semibold">Tambah Kelas Baru</span>
                </a>
            </div>
        </div>
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            <div
                ...
                <div class="w-4/12 px-4 py-3 text-center"></div>
                ...
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-4/12 px-4 py-3 text-sm text-gray-600 text-center tracking-tight">
                        @foreach ($class->subjects as $subject)
                            <span
                                class="bg-gray-200 text-sm mr-1 mb-1 px-2 font-semibold border rounded-full">{{ $subject->subject_code }}</span>
                        @endforeach
                    </div>
                    <div class="w-2/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">
                    ...
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <a href="{{ route('class.assign.subject', $class->id) }}"
                            class="ml-1 bg-blue-600 block p-1 border border-blue-600 rounded-sm" title="Assign Subject">
                            <svg class="h-3 w-3 fill-current text-gray-100" aria-hidden="true" focusable="false"
                                data-prefix="fas" data-icon="align-right" class="svg-inline--fa fa-align-right fa-w-14"
                                role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                <path fill="currentColor"

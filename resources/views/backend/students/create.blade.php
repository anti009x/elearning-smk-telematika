...
@section('content')
    <div class="roles">
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('student.store') }}" method="POST" class="w-full max-w-xl px-6 py-12"
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input name="dateofbirth" id="datepicker-tc" autocomplete="off"
                            class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
                            type="text" value="{{ old('dateofbirth') }}">
                        @error('dateofbirth')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:w-2/3 block text-gray-600 font-bold">
                        <div class="relative">
                            <select name="parent_id"
                                class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-state">
                                <option value="">--Pilih Orang Tua Siswa--</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#datepicker-tc").datepicker({
                ...
                changeMonth: true, // Izinkan pengguna untuk memilih bulan
                changeYear: true, // Izinkan pengguna untuk memilih tahun
                yearRange: "1900:2023", // Rentang tahun yang ditampilkan
                maxDate: "+0d" // Batasi pemilihan tanggal hanya hingga hari ini
            });
        });
    </script>
@endpush

    ...
    <div class="create">
        ...
        <div class="w-full mt-8 bg-white rounded">
            <form action="{{ route('attendance.index') }}" method="GET"
                class="md:flex md:items-center md:justify-between px-6 py-6 pb-0">
                                        ...
                                        <div class="flex flex-row justify-between w-64">
                                            ...
                                            <div class="text-sm text-left text-gray-600 py-2 px-4 font-semibold">
                                                @if ($attendance->attendence_status)
                                                    <span
                                                        class="text-xs text-white bg-green-500 px-2 py-1 rounded-custom">P</span>
                                                @else
                                                    <span
                                                        class="text-xs text-white bg-red-500 px-2 py-1 rounded-custom">A</span>
                                                @endif
                                            </div>
                                        </div>
                                    @endforeach

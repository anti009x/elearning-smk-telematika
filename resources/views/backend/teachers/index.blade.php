    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('teacher.create') }}"
                    ...
                    <span class="ml-2 text-xs font-semibold">TAMBAH GURU</span>
                </a>
            </div>
        </div>
        ...
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            <div
                ...
                <div class="w-3/12 px-4 py-3">Subjek Kode</div>
                <div class="w-2/12 px-4 py-3">Nomor Hp</div>
                ...
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-3/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">
                        @foreach ($teacher->subjects as $subject)
                            <span
                                class="bg-gray-200 text-sm mr-1 mb-1 px-2 border rounded-full">{{ $subject->subject_code }}</span>
                        @endforeach
                    </div>
                    <div class="w-2/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">{{ $teacher->phone }}
                    </div>
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <a href="{{ route('teacher.destroy', $teacher->id) }}"
                            ...
                            class="deletebtn ml-1 bg-red-600 block p-1 border border-red-600 rounded-sm">

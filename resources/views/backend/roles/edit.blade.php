        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('roles-permissions') }}"
                    class="bg-gray-700 text-white text-sm uppercase py-2 px-4 mr-2 flex items-center rounded">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <input name="name"
                            ...
                            id="inline-full-name" type="text" value="{{ $role->name }}">
                        @error('name')
                    ...
                    <div class="md:w-2/3 block text-gray-600 font-bold">
                        @foreach ($permissions as $permission)
                            <div class="flex items-center">
                                <label>
                                    <input name="selectedpermissions[]" class="mr-2 leading-tight" type="checkbox"

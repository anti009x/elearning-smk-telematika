...
@section('content')
    <div class="roles">
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('parents.update', $parent->id) }}" method="POST" class="w-full max-w-xl px-6 py-12"
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <img class="w-20 h-20 sm:w-32 sm:h-32 rounded"
                            src="{{ asset('images/profile/' . $parent->user->profile_picture) }}" alt="avatar">
                    </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
